	  ...
	  <script type="text/javascript">
		  $(function () {
			  ...
			  $("#first").click(function () {
				  location.href = "/admin?method=findAllBorrowByState&page=" + 1;
			  });
			  //下一页
			  $("#next").click(function () {
				  ...
				  location.href = "/admin?method=findAllBorrowByState&page=" + page;
			  });
			  //上一页
			  ...
			  //尾页
			  $("#last").click(function () {
				  location.href = "/admin?method=findAllBorrowByState&page=" + parseInt($("#pages").text());
			  });
		  })
	  </script>
  </head>
    ...
    <%@ include file="top.jsp" %>
  	...
  	<div id="main">
		<div class="navigation">
				回到:&nbsp;&nbsp;<a href="/admin?method=getBorrowed&page=1">还书管理</a>
		...
		<hr class="hr"/>
		<div id="pageControl">
			<div class="pageControl_item">共<font id="dataPrePage">${dataPrePage }</font>条数据</div>
